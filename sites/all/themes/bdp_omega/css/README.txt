...
To use these stylesheets, rename the files and bdp_omega with the name of your theme.
...
bdp_omega-alpha-default-narrow.css  
...
bdp_omega-alpha-default-normal.css
...
bdp_omega-alpha-default-wide.css
